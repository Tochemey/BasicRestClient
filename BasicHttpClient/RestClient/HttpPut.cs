namespace BasicRestClient.RestClient
{
    public class HttpPut : HttpRequest
    {
        ...
        /// <summary>
        /// Constructs an HTTP PUT request with arbitrary content. If parameters is non-null, the name-value pairs will be appended to the QUERY STRING while
        /// the content is sent in the request BODY. This is not a common use case and is therefore not represented in the put() methods in
        ...
        public HttpPut(string path, ParameterMap parameters, string contentType, byte[] data)
