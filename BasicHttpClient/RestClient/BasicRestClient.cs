namespace BasicRestClient.RestClient {
    public class BasicRestClient : AbstractRestClient {
        public BasicRestClient(bool logRequest, int connectionLimit) : base(connectionLimit) { LogRequest = logRequest; }

        public BasicRestClient(string baseUrl, IRequestHandler requestHandler) : base(baseUrl, requestHandler) { LogRequest = true; }
